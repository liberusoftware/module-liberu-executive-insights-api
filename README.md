...
[![Latest release](https://img.shields.io/github/v/release/liberusoftware/module-liberu-executive-insights-api?sort=semver)](https://github.com/liberusoftware/module-liberu-executive-insights-api/releases/latest) [![Tests](https://github.com/liberusoftware/module-liberu-executive-insights-api/actions/workflows/tests.yml/badge.svg?branch=main)](https://github.com/liberusoftware/module-liberu-executive-insights-api/actions/workflows/tests.yml)
...
```bash
composer require liberusoftware/module-liberu-executive-insights-api
```
...
<a href="https://github.com/liberusoftware/module-liberu-executive-insights-api/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=liberusoftware/module-liberu-executive-insights-api" alt="Contributors to liberusoftware/module-liberu-executive-insights-api">
</a>

[View the full contributors graph](https://github.com/liberusoftware/module-liberu-executive-insights-api/graphs/contributors).
